...
- Go 1.23 (go.mod), CI tests against 1.22 + 1.23 + `github.com/spf13/cobra` v1.8.1 (CLI), `github.com/mark3labs/mcp-go` v0.20.1 (MCP protocol), `modernc.org/sqlite` v1.34.4 (database), `github.com/pelletier/go-toml/v2` (config) (004-v04-release-hardening)
- SQLite via `modernc.org/sqlite` (pure Go, CGO_ENABLED=0) (004-v04-release-hardening)
...
## Recent Changes
- 004-v04-release-hardening: Added Go 1.23 (go.mod), CI tests against 1.22 + 1.23 + `github.com/spf13/cobra` v1.8.1 (CLI), `github.com/mark3labs/mcp-go` v0.20.1 (MCP protocol), `modernc.org/sqlite` v1.34.4 (database), `github.com/pelletier/go-toml/v2` (config)
